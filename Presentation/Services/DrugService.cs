...
namespace Presentation.Services
{
    public class DrugService
    {
        ...
        public void Create()
        {
            ...
            DrugPriceDesc: ConsoleHelper.WriteWithColor("Enter Price of the drug", ConsoleColor.Cyan);
                decimal price;
            ...
            DrugCountDesc: ConsoleHelper.WriteWithColor("Enter Count of the drug", ConsoleColor.Cyan);
                int count;
        ...
        public void Update()
        {
            ...
            {
                GetAll();
            DrugIdDesc: ConsoleHelper.WriteWithColor("Enter Id of the drug that you want to update", ConsoleColor.Cyan);
                int drugId;
        ...
        public void Delete()
        {
            ...
            {
                GetAll();
            DrugIdDesc: ConsoleHelper.WriteWithColor("Enter Id of the drug that you want to delete", ConsoleColor.Cyan);
                int drugId;
                bool issucceeded = int.TryParse(Console.ReadLine(), out drugId);
                if (!issucceeded)
                {
